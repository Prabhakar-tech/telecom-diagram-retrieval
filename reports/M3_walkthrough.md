...
|-------|-----------|-----|-----|------|--------|--------|---------|
| **Q1** | B1 BM25 Caption | 0.7966 | 0.9981 | **1.0000** | 0.8903 | 1.0000 | 0.9241 |
| **Q1** | B2 BM25 Cap+Ctx | 0.6660 | 0.9503 | 0.9796 | 0.7907 | 0.9841 | 0.8239 |
| **Q1** | D1 BGE Caption | 0.7934 | 0.9981 | **1.0000** | 0.8880 | 1.0000 | 0.9207 |
| **Q1** | D2 BGE Cap+Ctx | 0.7204 | 0.9748 | 0.9899 | 0.8354 | 0.9936 | 0.8700 |
| **Q2** | B1 BM25 Caption | 0.7568 | 0.9870 | **0.9952** | 0.8609 | 0.9952 | 0.8929 |
| **Q2** | B2 BM25 Cap+Ctx | 0.5526 | 0.8619 | 0.9055 | 0.6843 | 0.9177 | 0.7140 |
| **Q2** | D1 BGE Caption | 0.7616 | 0.9819 | 0.9918 | 0.8613 | 0.9918 | 0.8926 |
| **Q2** | D2 BGE Cap+Ctx | 0.6614 | 0.9331 | 0.9586 | 0.7822 | 0.9634 | 0.8137 |
| **Q3** | B1 BM25 Caption | 0.3001 | 0.5217 | 0.5929 | 0.3965 | 0.5954 | 0.4108 |
| **Q3** | B2 BM25 Cap+Ctx | 0.6304 | 0.9328 | **0.9706** | 0.7631 | 0.9715 | 0.7870 |
| **Q3** | D1 BGE Caption | 0.3628 | 0.5997 | 0.6581 | 0.4631 | 0.6601 | 0.4805 |
| **Q3** | D2 BGE Cap+Ctx | 0.6143 | 0.9108 | 0.9466 | 0.7423 | 0.9472 | 0.7666 |
...
| Experiment | R@10 | Δ vs caption-only counterpart |
|-----------|------|-------------------------------|
| B1 BM25 Caption | **0.9952** | baseline |
| D1 BGE Caption | 0.9918 | −0.0035 vs B1 |
| B2 BM25 Cap+Ctx | 0.9055 | — |
| D2 BGE Cap+Ctx | 0.9586 | **+0.0531 vs B2** |
...
| Experiment | R@10 | Notes |
|-----------|------|-------|
| B1 BM25 Caption | 0.5929 | Low — lexical gap between context and caption |
| D1 BGE Caption | 0.6581 | **+6.5% vs B1** — semantic bridge helps |
| B2 BM25 Cap+Ctx | **0.9706** | Best overall — context indexed, context queried |
| D2 BGE Cap+Ctx | 0.9466 | −2.4% vs B2 — BM25 exploits shared context vocab better |
...
4. **Next step — M4 BGE-large** will test if 1024-d embeddings and a stronger encoder improve R@1 and MRR@10, which are the remaining quality gap areas.
