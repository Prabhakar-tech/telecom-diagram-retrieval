...
PY="/DATA1/prabhakar/llava_env/bin/python"
...
"$PY" -m pip list | grep -iE "torch|torchvision|transformers|sentence|faiss|qdrant|chromadb|pillow|opencv|pandas|numpy|sklearn|scikit|accelerate|bitsandbytes" || true
